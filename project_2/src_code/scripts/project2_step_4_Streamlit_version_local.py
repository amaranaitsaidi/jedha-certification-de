...
# -----------------------------------------
st.set_page_config(
    page_title="Reviews Analytics",
    layout="wide",
    initial_sidebar_state="expanded"
)

st.title("📊 Reviews Analytics Dashboard")
st.markdown("Analyse des avis utilisateurs basée sur l’algorithme de pertinence.")
...
def init_connection():
    return snowflake.connector.connect(
            ...
            schema=os.getenv('SNOWFLAKE_SCHEMA', 'REVIEW'),
...
# Titre
# -------------------------------------------------------------------
st.title("📊 Analyse de la pertinence des avis Amazon")
st.markdown("Cette interface explore les avis selon les scores NLP et règles métiers.")
